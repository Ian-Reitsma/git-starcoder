...
Usage:
    python run_pipeline.py --repo /Users/ianreitsma/projects/the-block --run all
    python run_pipeline.py --repo /Users/ianreitsma/projects/the-block --run scrape,tokenize
"""
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="all",
        help="Comma-separated steps or 'all'"
    )
