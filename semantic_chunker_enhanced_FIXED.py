...
class CodeChunk:
    ...
    # Relationships (FIXED: colon added)
...
class EnhancedSemanticChunker:
    ...
    def _build_cross_file_context(self, commit: Dict, target_file: str) -> List[CrossFileContext]:
        ...
        # Extract trait/struct definitions
        ...
        for impl_block in defs["impl_blocks"][:3]:  # Limit to 3
            contexts.append(CrossFileContext(
    ...
    def chunk_commit(self, commit: Dict[str, Any]) -> List[CodeChunk]:
        ...
        for diff_idx, diff in enumerate(commit["diffs"]):
            ...
            # EXPANDED LIMITS (4000 chars instead of 2000)
